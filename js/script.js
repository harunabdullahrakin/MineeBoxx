...
const config = {
    serverInfo: {
        ...
        serverName: "MineeBoxx Network", /*Server name*/
        serverIp: "play.mineeboxx.xyz", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1182724060367556638", /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    */
    ...
    atGroupsDefaultColors: {
        Founders: "rgba(255, 124, 124, 0.5)",
        Team: "rgba(255, 124, 124, 0.5)",
        developers: "rgba(230, 83, 0, 0.5)",
        Workers: "rgba(11, 175, 255, 0.5)",
        ...
        Founders: [
            {
                inGameName: "Afonex",
                rank: "Owner",
                skinUrlOrPathToFile: "https://i.ibb.co/mvjhn6H/afonex.png",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "Basti20999",
                rank: "Owner",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "HarunAbdullah",
                rank: "Owner",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "Samgamingyt02",
                rank: "Owner",
                skinUrlOrPathToFile: "https://i.ibb.co/kXGQqCw/sam.png",
                rankColor: "rgba(255, 3, 3, 1)"
            }
        ],
        Team: [
            {
                ...
                rank: "Manager",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 0, 221)"
            },
            {
                inGameName: "Doggydon3928",
                rank: "Manager",
                skinUrlOrPathToFile: "https://visage.surgeplay.com/bust/512/590660fb394c48e382407a1e6e146d22",
                rankColor: "rgb(255, 0, 221)"
            },
            {
                inGameName: "Jellybelly1998",
                rank: "Manager",
                skinUrlOrPathToFile: "https://visage.surgeplay.com/bust/512/None",
                rankColor: "rgb(255, 0, 221)"
            },
            {
                inGameName: "File123_",
